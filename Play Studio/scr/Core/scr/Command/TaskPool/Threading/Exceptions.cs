...
namespace Play.Studio.Core.Command.TaskPool.Threading
{
    ...
    /// </summary>
    public sealed partial class WorkItemInvokeException : Exception
    {
        public WorkItemInvokeException()
        {
        }

        public WorkItemInvokeException(string message)
            : base(message)
        {
        }

        public WorkItemInvokeException(string message, Exception e)
            : base(message, e)
        {
        }
    }
