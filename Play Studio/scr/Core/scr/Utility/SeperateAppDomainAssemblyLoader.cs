...
namespace Play.Studio.Core.Utility
{
    ...
    public class SeperateAppDomainAssemblyLoader
    {
        ...
        public List<string> LoadAssembly(string assemblyPath)           
        {
            FileInfo assemblyLocation = new FileInfo(assemblyPath);
        ...
        class AssemblyLoader : MarshalByRefObject
        {
            ...
            internal List<string> GetTypes(string path) 
            {
                ...
                types.AddRange(reflectionOnlyAssembly.GetTypes().Select(X => X.AssemblyQualifiedName));
